                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage("assets/logo/oreedlogo.png"),
                          ),
                        ),
                      ),
                      Center(
                        ...
                        child: Column(
                          children: <Widget>[
                            Icon(
                              Icons.check_circle,
                              color:
                                  cart.stage > 0 ? Colors.amber : Colors.grey,
                            ),
                            SizedBox(
                              height: 5,
                            ),
                        ...
                        child: Column(
                          children: <Widget>[
                            Icon(
                              Icons.check_circle,
                              color:
                                  cart.stage > 1 ? Colors.amber : Colors.grey,
                            ),
                            Text('Address'),
                          ],
                        ),
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          if (cart.myCurrentAddresses != null) {
                            ...
                            ShowSnackBar(
                                context: context,
                                msg: "please fill all required fields in order",
                                bgColor: Colors.yellow.withOpacity(0.9),
                                textColor: Colors.black,
                                height: 25);
                          }
                        ...
                        child: Column(
                          children: <Widget>[
                            Icon(
                              Icons.check_circle,
                              color:
                                  cart.stage > 2 ? Colors.amber : Colors.grey,
                            ),
                            Text('Payment'),
                          ],
                        ),
                        ...
                        children: <Widget>[
                          Padding(
                            padding: const EdgeInsets.only(
                                left: 8.0, right: 8.0, top: 50, bottom: 12),
                            child: Card(
                                elevation: 5,
